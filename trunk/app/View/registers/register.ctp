...
<script type="text/JavaScript">
	...
	function submitData() {
		...
		jQuery.post("<?php echo $this->Html->url('/registers/insertFnc');?>"
				, {"cardtype":cardtype
					, "cardid":cardid
					, "titleth":titleth
					, "nameth":nameth
				...
				, function(data) {
					if ( data.result.length > 0 ) {
						...
						window.location.replace("<?php echo $this->webroot;?>profiles/index");
					}// if else
				}// function(data)
				, "json").error(function() {
				}// function()
...
<table align="center" class="tableLayout">
	...
	<tr>
		...
		<td class="tdData">
			<input type="text" id="text_birthday" class="textbox" value="" size="24"/>
		</td>
